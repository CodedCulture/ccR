#' Coded Culture report format (PDF)
#' 
#' Template for creating a Coded Culture report based on the style of 
#' Edward R. Tufte and Richard Feynman. 
#' 
#' @inheritParams pdf_document
#' 
#' @export
cc_report <- function(fig_width = 4,
                          fig_height = 2.5,
                          fig_crop = TRUE,
                          dev = 'pdf',
                          highlight = "default",
        ...
        # get the cc-report template
        template <-  system.file(
                "templates/cc_report/resources/cc_report.tex", 
                package = "ccR"
        )
